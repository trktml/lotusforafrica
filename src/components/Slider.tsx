...
import well4 from '../assets/img/slider/129-well.webp';
import well5 from '../assets/img/slider/130-well.webp';
import well6 from '../assets/img/slider/131-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 131. well image" data-src={well6.src} />
            <div data-alt="slider 130. well image" data-src={well5.src} />
            <div data-alt="slider 129. well image" data-src={well4.src} />
