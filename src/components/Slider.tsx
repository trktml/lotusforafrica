...
import well4 from '../assets/img/slider/144-well.webp';
import well5 from '../assets/img/slider/145-well.webp';
import well6 from '../assets/img/slider/146-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 146. well image" data-src={well6.src} />
            <div data-alt="slider 145. well image" data-src={well5.src} />
            <div data-alt="slider 144. well image" data-src={well4.src} />
