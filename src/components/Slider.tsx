...
import well4 from '../assets/img/slider/well-110.webp';
import well5 from '../assets/img/slider/well-111.webp';
import well6 from '../assets/img/slider/well-112.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 112. well image" data-src={well6.src} />
            <div data-alt="slider 111. well image" data-src={well5.src} />
            <div data-alt="slider 110. well image" data-src={well4.src} />
