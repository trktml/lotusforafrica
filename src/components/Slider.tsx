...
import well4 from '../assets/img/slider/well-117.webp';
import well5 from '../assets/img/slider/well-118.webp';
import well6 from '../assets/img/slider/well-119.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 119. well image" data-src={well6.src} />
            <div data-alt="slider 118. well image" data-src={well5.src} />
            <div data-alt="slider 117. well image" data-src={well4.src} />
