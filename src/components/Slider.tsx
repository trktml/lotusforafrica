...
import well4 from '../assets/img/slider/155-well.webp';
import well5 from '../assets/img/slider/156-well.webp';
import well6 from '../assets/img/slider/157-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 157. well image" data-src={well6.src} />
            <div data-alt="slider 156. well image" data-src={well5.src} />
            <div data-alt="slider 155. well image" data-src={well4.src} />
