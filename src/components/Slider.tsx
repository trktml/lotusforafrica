...
import well4 from '../assets/img/slider/146-well.webp';
import well5 from '../assets/img/slider/147-well.webp';
import well6 from '../assets/img/slider/148-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 148. well image" data-src={well6.src} />
            <div data-alt="slider 147. well image" data-src={well5.src} />
            <div data-alt="slider 146. well image" data-src={well4.src} />
