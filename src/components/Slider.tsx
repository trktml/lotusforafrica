...
import well4 from '../assets/img/slider/122-well.webp';
import well5 from '../assets/img/slider/123-well.webp';
import well6 from '../assets/img/slider/124-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 124. well image" data-src={well6.src} />
            <div data-alt="slider 123. well image" data-src={well5.src} />
            <div data-alt="slider 122. well image" data-src={well4.src} />
