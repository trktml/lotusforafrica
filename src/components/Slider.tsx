...
import well4 from '../assets/img/slider/138-well.webp';
import well5 from '../assets/img/slider/139-well.webp';
import well6 from '../assets/img/slider/140-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 140. well image" data-src={well6.src} />
            <div data-alt="slider 139. well image" data-src={well5.src} />
            <div data-alt="slider 138. well image" data-src={well4.src} />
