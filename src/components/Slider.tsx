...
import well4 from '../assets/img/slider/132-well.webp';
import well5 from '../assets/img/slider/133-well.webp';
import well6 from '../assets/img/slider/134-well.webp';
...
export default function Slider(params: AwesomeSliderProps) {
    return (
        ...
        >
            <div data-alt="slider 134. well image" data-src={well6.src} />
            <div data-alt="slider 133. well image" data-src={well5.src} />
            <div data-alt="slider 132. well image" data-src={well4.src} />
